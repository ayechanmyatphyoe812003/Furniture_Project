...
<div class="filter1 filter">
    ...
    <?php foreach ($categories as $category) : ?>
        <a href="<?= update_params("category", $category["categoryName"]) ?>" class="category-filter" data-category="<?= $category['categoryID'] ?>"><?= $category['categoryName'] ?></a>
    <?php endforeach; ?>
</div>
<div class="filter2 filter">
    ...
    <?php foreach ($brands as $brand) : ?>
        <a href="<?= update_params("brand", $brand["name"]) ?> "><?= $brand["name"] ?></a>
    <?php endforeach; ?>
</div>
